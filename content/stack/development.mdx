...
- Database: PostgreSQL, SQLite, Redis, MongoDB, Firebase, Supabase,MySQL
- Hosting: Vercel, Netlify, Firebase, Supabase, DigitalOcean, AWS,Cloudflare
- Domains: Namecheap,
- AI Tools:ChatGPT, Gemini, Claude, Ollama,Claude Cli,Gemini Cli